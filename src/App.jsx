...
export default function QSprint() {
  ...
  return (
    <div style={S.app}><style>{`@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700;0,900;1,400;1,700;1,900&family=IBM+Plex+Sans:wght@300;400;500;600;700&family=IBM+Plex+Mono:wght@400;500&display=swap');*{box-sizing:border-box;margin:0;padding:0}@keyframes fadeIn{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}@keyframes slideUp{from{opacity:0;transform:translateY(16px)}to{opacity:1;transform:translateY(0)}}.fade-in{animation:fadeIn .4s ease-out forwards}.slide-up{animation:slideUp .5s ease-out forwards}input:focus{outline:none;border-color:${T.blue}!important}button{cursor:pointer;border:none;font-family:'IBM Plex Sans',sans-serif;transition:all .15s}button:active{transform:scale(.97)}.hint-content{white-space:pre-line}`}</style>
...
// ─── Styles ───
const S = {
  app:{minHeight:"100vh",background:T.cream,fontFamily:"'IBM Plex Sans',sans-serif",color:T.text,overflowX:"hidden"},
  ctr:{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:"24px 16px"},
  welc:{maxWidth:480,width:"100%",overflow:"hidden"},
  ...
  card:{maxWidth:520,width:"100%",backgroundColor:T.white,borderRadius:14,overflow:"hidden",boxShadow:"0 2px 20px rgba(30,27,75,0.06)"},
  ...
  sec:{marginBottom:22},
  bp:{display:"block",width:"100%",padding:"14px 24px",fontSize:16,fontWeight:600,color:"#fff",backgroundColor:T.blue,borderRadius:8},
  bt:{display:"inline-block",padding:"14px 28px",fontSize:16,fontWeight:600,color:"#fff",backgroundColor:T.terra,borderRadius:8},
  bs:{display:"block",width:"100%",padding:"12px 24px",fontSize:15,fontWeight:500,color:T.textLt,backgroundColor:"transparent",borderRadius:8,border:`1.5px solid ${T.bdr}`,marginTop:8},
  bd:{display:"block",width:"100%",padding:"12px",marginTop:10,backgroundColor:T.errBg,color:T.errRed,border:`1px solid ${T.errBdr}`,borderRadius:8,fontWeight:600},
  ...
  sprint:{minHeight:"100vh",display:"flex",flexDirection:"column",padding:"0 16px 24px"},
  topB:{display:"flex",alignItems:"center",gap:14,padding:"14px 4px 10px",position:"sticky",top:0,zIndex:10,backgroundColor:T.cream},
  ...
  qA:{flex:1,display:"flex",flexDirection:"column",maxWidth:580,width:"100%",margin:"0 auto",paddingTop:16},
  ...
  fbA:{flex:1,display:"flex",flexDirection:"column",maxWidth:500,width:"100%",margin:"0 auto",paddingTop:32,gap:14},
  ...
  brkScr:{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:"24px 16px",background:`linear-gradient(180deg,${T.cream} 0%,#ede8df 100%)`},
  ...
  sumCard:{maxWidth:400,width:"100%",backgroundColor:T.white,border:`3px solid ${T.navy}`,overflow:"hidden"},
